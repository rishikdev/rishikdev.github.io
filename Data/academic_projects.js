...
[
    ...
    {
        name : "Interaction with Virtual Objects",
        ...
        description : "Demonstrated interacting with objects in virtual environment using hand pose estimation and a single RGB camera." +
                      "<br><br>Used MediaPipe's hand solution and OpenCV in the backend, Unity Game Engine in the frontend, and ZeroMQ and NetMQ to transfer data between the backend and the frontend.",
